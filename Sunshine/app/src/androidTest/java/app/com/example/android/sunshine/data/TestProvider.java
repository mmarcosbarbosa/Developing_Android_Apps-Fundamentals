...
public class TestProvider extends AndroidTestCase {
     ...
     */
    // DESISTOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
//    public void testProviderRegistry() {
//        PackageManager pm = mContext.getPackageManager();
//
//        // We define the component name based on the package name from the context and the
//        // WeatherProvider class.
//        ComponentName componentName = new ComponentName(mContext.getPackageName()+".data",
//                WeatherProvider.class.getName());
//        //ComponentName componentName = new ComponentName("app.com.example.android.sunshine.data",
//        //        "WeatherProvider");
//        Log.v ("testProviderRegister", "Passa aqui 1!");
//        try {
//            // Fetch the provider info using the component name from the PackageManager
//            // This throws an exception if the provider isn't registered.
//            Log.v ("testProviderRegister", "Passa aqui 2!");
//            Log.v("testProviderRegister", "" + componentName.getClassName().toString() );
//            Log.v("testProviderRegister", "" + componentName.getPackageName().toString());
//            ProviderInfo providerInfo =  pm.getProviderInfo(componentName, 0);
//            Log.v ("testProviderRegister", "Passa aqui 3!");
//
...
//            assertTrue("Error: " + WeatherProvider.class.getName() + " not registered at " + mContext.getPackageName(),
//                    false);
//        }
//    }
    ...
    public void testGetType() {
        ...
        String type = weatherProvider.getType(WeatherEntry.CONTENT_URI);
        Log.v("testGetType", "WeatherEntry.CONTENT_TYPE: "+ WeatherEntry.CONTENT_TYPE );
        Log.v("testGetType", "type: " + type );
        ...
        type = weatherProvider.getType(LocationEntry.CONTENT_URI);
